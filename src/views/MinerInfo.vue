...
export default {
  ...
  methods: {
    getMinersInfo() {
      var config = {
        method: 'get',
        url: this.$store.state.api_base_url+'/api/pools/novo/miners/'+this.$store.state.user_public_key+'',
        headers: { }
      };
      axios(config)
          .then((response)=> {
    ...
    getMinersPaymentInfo() {
      ...
      var config = {
        method: 'get',
        url: this.$store.state.api_base_url+'/api/pools/novo/miners/'+this.$store.state.user_public_key+'/payments',
        headers: { }
      };
